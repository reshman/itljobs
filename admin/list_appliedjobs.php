                                ...
                                <div class="box-body">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                       ...
                                       <tbody>
                                          <?php
                                          $uid = $_SESSION['id'];
                                          $qry = sprintf("SELECT js.id,js.job_listing,js.user_id,ja.job_id,ja.user_id,ja.created_date,us.name FROM jobs as js JOIN jobs_applied as ja ON js.id = ja.job_id JOIN users as us ON ja.user_id = us.id WHERE js.user_id='$uid'");
                                          $res = Db::query($qry);
                                          $i = 1;
