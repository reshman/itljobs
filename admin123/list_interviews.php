                                    ...
                                    <table id="example2" class="table table-bordered table-hover">
                                       ...
                                       <tbody>
                                          ...
                                          $today_date = date('Y-m-d');
                                           $query = sprintf("SELECT us.id,us.name,iv.id as intId,jc.name as job_title,iv.schedule_date, iv.name as jobname, iv.user_id,iv.active,iv.del_status FROM interviews as iv INNER JOIN users as us ON us.id=iv.user_id INNER JOIN job_categories as jc ON iv.title=jc.id WHERE iv.schedule_date>='%s' AND iv.del_status='%s'",$today_date,0); 
