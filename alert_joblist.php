 ...
 <form> 
  ...
  <input type="text" placeholder="COUNTRY" id="box2">
   <input type="submit" value="SEARCH JOBS" id="btn-search">
       ...
       <div class="row">
       <div class="col-md-12">
       <div class="title-section" style="margin-top:25px;">
       ...
       <p><span style="color:#6495ED">Location : </span><?php echo $row['job_location'];?> <span style="color:#6495ED">Closing Date : </span><?php echo $row['closing_date'];?></p>
