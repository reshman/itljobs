...
<head>
    ...
    <script
        src="http://maps.googleapis.com/maps/api/js?sensor=false&amp;libraries=places&key=AIzaSyBKY3LssTzDjFxtaPU3bx0YjZDRYxgj2Tk"></script>
    ...
    <div class="col-md-12 companyname2">
        ...
        <select name="job_category_id" class="job" id="category">
            ...
            while ($row = mysql_fetch_array($res)) {
                ?>
                <option <?php echo ($jobcat == $row['id']) ? 'selected = selected' : ''; ?>
    ...
    <div class="col-md-4 col-sm-12 col-xs-12 companyname3">
        ...
        <select name="qualification" id="qualification" class="select2">
            ...
            while ($rowq = mysql_fetch_assoc($resqua)) {
                ?>
                <option
                    value="<?php echo $rowq['qualification']; ?>" <?php if ($rowresult['qualification'] == $rowq['qualification']) {
                    echo "selected";
...
<div class="col-md-12">
    ...
    <div class="col-md-4 col-sm-12 col-xs-12">
        <select name="abroad" class="exp">
            ...
            <?php for ($i = 0; $i <= 40; $i++) { ?>
                <option <?php echo ($ab_exp == $i) ? 'selected = selected' : ''; ?>
                    value="<?php echo $i; ?>"><?php echo "$i year(s)"; ?></option>
            <?php } ?>
        </select>
    </div>
    ...
    <div class="col-md-4 col-sm-12 col-xs-12">
        <select name="india" class="inexp">
            ...
            <?php for ($i = 0; $i <= 40; $i++) { ?>
                <option <?php echo ($ind_exp == $i) ? 'selected = selected' : ''; ?>
                    value="<?php echo $i; ?>"><?php echo "$i year(s)"; ?></option>
            <?php } ?>
        </select>
    </div>
    <?php
    $total = $rowresult['experience'];
    $year = floor($total);
    ...
    switch ($month) {
        case 0:
            $month_string = '0 Month(s)';
            break;
        case 0.25:
            $month_string = '3 Month(s)';
            break;
        case 0.5:
            $month_string = '6 Month(s)';
            break;
        case 0.75:
            $month_string = '9 Month(s)';
            break;
        default:
            $month_string = '';
    }
    ...
    <div class="col-md-4 col-sm-12 col-xs-12" id="totalyrs">
        <input name="total1" id="email" type="text" placeholder="TOTAL YEARS" disabled=""
               value="<?php echo $display_string ?>">
    </div>

    <div class="col-md-4 col-sm-12 col-xs-12" id="result" style="display: none;">
        <input name="total" id="email" type="text" placeholder="TOTAL YEARS" value="<?= $rowresult['experience'] ?>"
               disabled="">
    </div>
...
<div class="col-md-2 col-sm-12 col-xs-12">
    <input name="mobile" id="mobile" type="text" placeholder="Mobile" value="<?php echo $rowresult['mobile'] ?>"
           maxlength="10">
</div>
...
<div class="col-md-4 col-sm-12 col-xs-12">
    <input name="current_location" id="location" type="text" placeholder="CURRENT LOCATION "
           value="<?php echo $rowresult['current_location'] ?>">
</div>
...
<div class="col-md-12">
    ...
    <div class="col-md-2 col-sm-12 col-xs-12">
        <img src="verificationimage.php?<?php echo rand(0, 9999); ?>" alt="verification image, type it in the box"
             width="150" height="50" align="absbottom" id="captcha"/>
    </div>
    <div class="col-md-2 col-sm-12 col-xs-12">
...
<div class="col-md-12">
    ...
    <label
        for="f02"><?php echo isset($rowresult['file_name']) ? $rowresult['file_name'] : 'UPLOAD YOUR CV (DOC, DOCX, PDF, JPG, PNG, BMP, GIF)' ?></label>
