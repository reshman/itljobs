        ...
        <div class="contact-section">
            <div class="contact-info">
                ...
                <ul class="information-list">
                    ...
                    <li><i class="fa fa-phone"></i><span> 0491 - 2536784 / 85 / 86 </span><span>0491 - 2539022</span></li>
    ...
    <div class="col-md-6">
        <div class="contact-section">
            <div class="contact-info">
                <h2>Thiruvalla</h2>
                <ul class="information-list">
                    <li><i class="fa fa-map-marker"></i><span>ITL Tours & Travels, 1st Floor,Marthoma Building, M.C.Road, Thiruvalla – 689101, Kerala</span></li>
                    <li><i class="fa fa-phone"></i><span>0469-2701555 / 2555 / 3555 /  4555</span></li>
        ...
        <div class="contact-section">
            <div class="contact-info">
                ...
                <ul class="information-list">
                    ...
                    <li><i class="fa fa-phone"></i><span>+966 - 38983222 /  +966 - 38988997</span></li>
                    <li><i class="fa fa-envelope-o"></i></li>
                </ul>
            </div>
        </div>
