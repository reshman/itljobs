...
<!--		<section id="home-section" class="slider2">
	...
	<li><i class="fa fa-envelope-o"></i><a href="#">vashi@itltravel.com</a></li>
	</ul>						
	</div>
        </div>
        </div> 
	...
	<h2>Palakkad</h2>
	<ul class="information-list">
	<li><i class="fa fa-map-marker"></i><span>ITL Tours & Travels Pvt. Ltd., 1 st Floor,Choice Tower, G.B.Road,Palakkad, Kerala- 678001</span></li>
	<li><i class="fa fa-phone"></i><span> +91 491 2536784, 85, 86 </span><span>+91 491 2539022</span></li>
	<li><i class="fa fa-envelope-o"></i><a href="#">pgt_itl@itltravel.com</a></li>
	</ul>						
	</div>
        </div>
        </div>
	...
	<li><i class="fa fa-phone"></i><span>+91 495 -2369843 / 3216555 / 4017555.</span><span>+91 495-2768543</span></li>
        <li><i class="fa fa-envelope-o"></i><a href="#">itlclt@itlservice.net</a></li>
	</ul>						
	</div>
        </div>
        </div>
	...
	<li><i class="fa fa-phone"></i><span>0431- 2412736/37/38</span><span>0431 2412739</span></li>
        <li><i class="fa fa-envelope-o"></i><a href="#">trichy@itltravel.com</a></li>
	</ul>						
	</div>
        </div>
        </div>
	...
	<h2>Chennai</h2>
	<ul class="information-list">
	<li><i class="fa fa-map-marker"></i><span>ITL Tours & Travels Pvt. Ltd., No.23 & 24, Ground Floor, 47, Whites Road, Deshbhandu Plaza, Royapettah, Chennai - 600 014, Tamil Nadu, India.</span></li>
	<li><i class="fa fa-phone"></i><span>+91 44 28552246, 47, 48</span><span>+91 44 28552249</span></li>
        <li><i class="fa fa-envelope-o"></i><a href="#">itlchennai@itltravel.com</a></li>
	</ul>						
	</div>
        </div>
        </div>
	...
	<h2>Thiruvalla</h2>
	<ul class="information-list">
	<li><i class="fa fa-map-marker"></i><span>ITL Tours & Travels Pvt. Ltd., 1st Floor,Marthoma Building, M.C.Road, Thiruvalla – 689101, Kerala</span></li>
	<li><i class="fa fa-phone"></i><span>+91 469 2701555 , 2555,3555, 4555</span></li>
        <li><i class="fa fa-envelope-o"></i><a href="#">thiruvalla@itltravel.com</a></li>
	</ul>						
	</div>
        </div>
        </div>
