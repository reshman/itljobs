                            ...
                            <div class="accord-elem">
                                ...
                                <div class="accord-content" style="display: none;">
                                    ...
                                    <p class="c_b_t_border">
                                        <span
                                            style="color:#007ac9">Experience : </span><?php echo ($row['experience'] == 0) ? $row['experience'] . ' year' : $row['experience']; ?>
                                        ,
                                        <span style="color:#007ac9">Reference Id : </span><?php echo $row['ref_id']; ?>,
                                        <span
                                            style="color:#007ac9">Closing date : </span><?php echo date("d/m/Y", strtotime($row['closing_date'])); ?>
                                        ,
                                        <span
                                            style="color:#007ac9">Location : </span><?php echo $row['job_location']; ?>
                                    </p>
                                    ...
                                    <?php if (isset($_SESSION['log'])): ?>
                                        ...
                                        <?php if (!in_array($row['id'], $jobsArray)): ?>
                                            <div id="view"><a href="javascript:void(0)"
                                                              onclick="view(<?php echo $row['id'] ?>, this)"><input
                                                        type="submit"
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div id="view"><a href="javascript:void(0)" data-toggle="modal"
                                                          data-target="#myModal"><input type="submit" value="SAVE"></a>
                                        </div>
                                    <?php endif; ?>
                    ...
                    while ($row = mysql_fetch_array($result)) {
                        ...
                        <div class="accord-elem">
                            ...
                            <div class="accord-content" style="display: none;">
                                ...
                                <?php else: ?>
                                    <div id="apply"><a href="javascript:void(0)" data-toggle="modal"
                                                       data-target="#myModal"><input type="submit" value="APPLY"></a>
                                    </div>
                                    <div id="view"><a href="javascript:void(0)" data-toggle="modal"
                                                      data-target="#myModal"><input type="submit" value="SAVE"></a>
                                    </div>
