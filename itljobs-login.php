...
<section class="register-section">
    <div class="container">
        ...
        <form id="contact-form" method="POST" action="login.php" enctype="multipart/form-data">
            <?php
            error_reporting(0);
            session_start();
            if ($_SESSION['in'] == 1) {
            ...
            unset($_SESSION['in']);
            ?>
            <div id="sucess" style="display:none; color:#006633; margin-left: 20px; font-size:16px;"><b>Invalid
                    Email</b></div>
            ...
            <div class="col-md-12">
                ...
                <div>
                    <a class="forgot" data-toggle="modal" data-target="#myModal" href="javascript:void(0)">Forgot
                        Password?</a>
                    <a class="pull-right" href="itljobs-registration.php">Not registered?</a>
                </div>
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="input-group add-on">
                                <input type="email" class="form-control" required name="forgotemail"
                                       id="field-forgotemail" value="" placeholder="ENTER YOUR EMAIL ID"/>
                            </div>

                            <div class="row">
                                <div id="error" style="display:none; color:#C80000; margin-left: 20px; font-size:16px;">
                                    <b>Invalid Email</b></div>
                            </div>
                            <div class="bg-success text-center" id="success-message"
                                 style="padding: 10px; margin: 10px;"></div>
                        </div>
