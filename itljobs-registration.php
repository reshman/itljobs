...
<div class="col-md-1 col-sm-12 col-xs-12">
    <img src="verificationimage.php?<?php echo rand(0, 9999); ?>" alt="verification image, type it in the box"
         width="100%" height="50" align="absbottom" id="captcha"/>
</div>
...
<div class="col-md-12">
    <input type="file" class="col-md-12 col-sm-12 col-xs-12 resume" name="fileToUpload" id="f02"
    ...
    $(function () {
        ...
        $("#contact-form").validate({
            ...
            messages: {
                ...
                sub_category: "Please select Job applied for",
