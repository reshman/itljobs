       ...
       <!--     ************************************************  -->
        ...
        <div class="col-md-4">
           ...
           <select name="qualification">
            ...
            <option value="Mr">B.A</option>
            <option value="Mrs">B.Arch</option>
            <option value="Miss">BCA</option>
            <option value="Ms">BBA</option>
            <option value="Ms">B.Com</option>
            <option value="Ms">B.Ed</option>
            <option value="Ms">BDS</option>
            <option value="Ms">BHM</option>
            <option value="Ms">B.Pharma</option>
            <option value="Ms">B.Sc</option>
            <option value="Ms">B.Tech / B.E</option>
            <option value="Ms">LLB</option>
            <option value="Ms">MBBS</option>
            <option value="Ms">Diploma</option>
            <option value="Ms">BVSC</option>
            <option value="Ms">CA</option>
            <option value="Ms">CS</option>
            <option value="Ms">ICWA (CMA)</option>
            <option value="Ms">Integrated PG</option>
            <option value="Ms">LLM</option>
            <option value="Ms">M.A</option>
            <option value="Ms">M.Arch</option>
            <option value="Ms">M.Com</option>
            <option value="Ms">M.Ed</option>
            <option value="Ms">M.Pharma</option>
            <option value="Ms">MSc</option>
            <option value="Ms">M.Tech</option>
            <option value="Ms">MBA/PGDM</option>
            <option value="Ms">MCA</option>
            <option value="Ms">MS</option>
            <option value="Ms">PG Diploma</option>
            <option value="Ms">MVSC</option>
            <option value="Ms">MCM</option>
            <option value="Ms">Ph.D/Doctorate</option>
