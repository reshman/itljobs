...
<!--		<section id="home-section" class="slider2">
	...
	<section class="register-section">
        ...
        <form id="contact-form" method="POST" action="registration.php" enctype="multipart/form-data">  
             <?php
                          ...
                          if ($_SESSION['regsucc'] != '') {
                            ...
                            <div class="alert alert-danger">
                            <?php echo "<span style='color:red'/><b>Upload pdf,doc or docx file</b></span><br/><br/>"; ?>
                            </div>
                            <?php
                             }else{ ?>
                              <div class="alert alert-danger">
        ...
        <div class="col-md-4">
            <select name="experience" class="expyrs">
        ...
        <option disabled="" selected="">ABROAD</option>
        <?php
        for($i=0;$i<=40;$i++){  ?>
        <option value="<?php echo $i;?>" ><?php echo "$i year(s)";?></option>
        <?php } ?>
        ...
        <input name="total" id="email" type="text" placeholder="TOTAL YRS">    
        </div>
        ...
        <select name="abroad_experience">
        <option disabled="" selected="">ABROAD EXPERIENCE</option>
        ...
        <input name="captcha" id="captcha-form" autocomplete="off" type="text" placeholder="ENTER NUMBER"> 
        </div>
        <div class="col-md-2">
        ...
        id="change-image">Not readable? Refresh.</a>
         ...
         <div class="col-md-12">
            ...
            <input type="file"  name="fileToUpload" id="f02" placeholder="UPLOAD YOUR CV">
