 ...
 <form> 
  ...
  <input type="text" placeholder="COUNTRY" id="box2">
   <input type="submit" value="SEARCH JOBS" id="btn-search">
                 	...
                 	<div class="col-md-3">
						<div class="side-navigation">
							<ul class="side-navigation-list">
								<li><a class="active" href="services.html">EDIT MY PROFILE</a></li>
		...
		<div class="service-content">
		<h2><a href="my-jobs.php">MY JOBS</a></h2>
		</div>
		</div>
		</div>
		...
		<div class="service-content">
		<h2><a href="alerts.php">ALERTS</a></h2>
		</div>
		</div>
		</div>
		...
		<div class="service-content">
		<h2><a href="myaccount.php">MY ACCOUNT</a></h2>
		</div>
		</div>
		</div>
