                        ...
                        <div class="col-md-10">
                            <div class="accordion-box">
                                <div class="accord-elem">
                                    ...
                                    <?php
                                    include 'db.php';
                                    $query = sprintf("SELECT j.job_listing, j.job_description,j.id, j.experience,j.job_location,j.closing_date,j.company_name,j.ref_id  FROM jobs j JOIN  jobs_saved js ON j.id = js.job_id WHERE js.user_id = '%s' AND js.del_status = '%s' AND j.del_status=%d", $id, 0, 0);
                                            ...
                                            <div class="accord-content" style="display: none;" id="accord-saved-<?php echo $row['id']; ?>">
                                                ...
                                                <p><?php
                                                    if ($row['job_description'] == "PDF Attached") {
                                                        echo $row['job_description'] . '- <a href="jobdescriptions/' . $row['ref_id'] . '.pdf">View Here</a>';
                                                    } else {
                                ...
                                <div class="accord-elem">
                                    ...
                                    <div id="applied-affix">
                                        <?php
                                        $qry = sprintf("SELECT j.id, j.job_description,j.job_location,  j.experience, j.closing_date, j.job_listing,j.company_name,j.ref_id FROM jobs j JOIN `jobs_applied` ja ON j.id = ja.job_id WHERE ja.user_id = '%s' AND ja.del_status = '%s' AND j.del_status=%d", $id, 0, 0);
                                        $res = Db::query($qry);
                                        if (mysql_num_rows($res) > 0) {
                                            while ($rw = mysql_fetch_array($res)) {
                                                ...
                                                <div class="accord-content" style="display: none;">
                                                    ...
                                                    <p><?php
                                                        if ($rw['job_description'] == "PDF Attached") {
                                                            echo $rw['job_description'] . '- <a href="jobdescriptions/' . $rw['ref_id'] . '.pdf" target="_BLANK">View Here</a>';
                                                        } else {
                                                            echo $rw['job_description'];
                                                        }
                                                        ?>
                                                    </p>
                                                    <p>
                                ...
                                <div class="accord-elem">
                                    ...
                                    $today = date('Y-m-d');
                                    $qryOffer = sprintf("SELECT * FROM jobs WHERE active='%s' AND del_status=0 AND job_category_id = '%s' AND closing_date>='%s' AND id NOT IN('%s') ORDER BY job_order DESC", 1, $jobCategoryId, $today, $jobsStr, 0);
                                    ...
                                    if (mysql_num_rows($resOffer) > 0) {
                                        while ($rwofr = mysql_fetch_array($resOffer)) {
                                            ...
                                            <div class="accord-content" style="" id="accord-offered-<?php echo $rwofr['id']; ?>">
                                                ...
                                                <p><?php
                                                    if ($rwofr['job_description'] == "PDF Attached") {
                                                        echo $rwofr['job_description'] . '- <a href="jobdescriptions/'.$rwofr['ref_id'].'.pdf">View Here</a>';
                                                    } else {
                                                        echo $rwofr['job_description'];
                                                    }
                                                    ?>
                                                </p>
                                                <p>
