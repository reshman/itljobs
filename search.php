...
//                                                  $experience    = $_POST['experience'];
                                            ...
                                            $total_query = $query_st;
                                            $query_st = $query_st . ' LIMIT ' . $start . ',' . $num_rec_per_page;
                                                ...
                                                <tbody>
                                                    ...
                                                    while ($row = mysql_fetch_array($result)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><a href="download-recruiter-file.php?filename=<?php echo $row['file_name'] ?>" target="_blank"><?php
                                ...
                                if ($total_pages > 1) {
                                    ...
                                    <center>
                                        <ul class="pagination">
                                            <li <?php if ($page == 1) { ?> class='disabled' <?php } ?>><a href="search.php?category=<?= $category ?>&subcategory=<?= $subcategory ?>&experiencemin=<?= $experiencemin ?>&experiencemax=<?= $experiencemax ?>&location=<?= $location ?>&p=1"><<</a></li>
                                            <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                                                <li <?php if ($page == $i) { ?> class='active' <?php } ?>><a href="search.php?category=<?= $category ?>&subcategory=<?= $subcategory ?>&experiencemin=<?= $experiencemin ?>&experiencemax=<?= $experiencemax ?>&location=<?= $location ?>&p=<?= $i ?>"><?= $i ?></a></li>
                                            <?php } ?>
                                            <li <?php if ($page == $total_pages) { ?> class='disabled' <?php } ?>><a href="search.php?category=<?= $category ?>&subcategory=<?= $subcategory ?>&experiencemin=<?= $experiencemin ?>&experiencemax=<?= $experiencemax ?>&location=<?= $location ?>&p=<?= $total_pages ?>">>></a></li>
                                        </ul>
                                    </center>
                                <?php } ?>
                            </div>
